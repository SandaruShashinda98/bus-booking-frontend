...
//                   <div
//                     key={item._id}
//                     className="flex items-center justify-between p-3 bg-white bg-opacity-80 rounded-lg shadow-sm"
//                   >
//                     <div className="flex flex-col">
//                       <span className="text-lg font-medium">
//                         {item.food} - Rs. {item.price || 0}
//                       </span>
//                       {item.ingredients && (
...
//                 type="button"
//                 onClick={skipOrder}
//                 className="flex-1 py-3 bg-gray-800 text-white rounded-md hover:bg-gray-700 disabled:bg-gray-400"
//                 disabled={isSubmitting}
//               >
//                 Skip
//               </button>
...
//                 disabled={isSubmitting}
//               >
//                 {isSubmitting ? "Processing..." : "Proceed Booking"}
//               </button>
//             </div>
//           </form>
//         </div>
